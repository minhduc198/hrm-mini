        ...
        <div className="flex items-center gap-1.5 mr-1">
          ...
          {hiddenCount > 0 && (
            <button
              ...
              className="w-8 h-8 rounded-full bg-subtle border border-line hover:bg-subtle/80 transition-colors flex items-center justify-center overflow-hidden"
            >
