...
export const addEmployeeSchema = z
  ...
  .refine((d: { password?: string; password_confirmation?: string }) => d.password === d.password_confirmation, {
...
export const changePasswordSchema = z
  ...
  .refine((data: { new_password?: string; new_password_confirmation?: string }) => data.new_password === data.new_password_confirmation, {
    message: "Mật khẩu xác nhận không khớp",
